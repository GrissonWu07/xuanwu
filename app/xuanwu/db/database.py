...
class DatabaseConfig:
    ...
    def __init__(
        ...
        self.sqlite_path = sqlite_path or "./data/xuanwu.db"
    ...
    def from_config(cls, config: dict[str, Any]) -> "DatabaseConfig":
        """Create DatabaseConfig from xuanwu.json config dict."""
        db_config = config.get("database", {})
        db_type = db_config.get("type", "sqlite")

        return cls(
            db_type=db_type,
            sqlite_path=db_config.get("sqlite", {}).get("path", "./data/xuanwu.db"),
