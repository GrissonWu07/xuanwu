"""
Auth configuration models loaded from the `auth` section of xuanwu.json.
...
DEFAULT_JWT_SECRET = "xuanwu-dev-secret"
...
class JWTAuthConfig(BaseModel):
    ...
    def _resolve_secret_key(self) -> str:
        ...
        env_secret = os.environ.get("XUANWU_JWT_SECRET", "").strip()
        if env_secret:
            return env_secret
