...
from app.xuanwu.core.workspace import WorkspaceInitializer, UserWorkspaceInitializer
...
class TestWorkspaceIntegration:
    ...
    def test_full_workspace_initialization_flow(self, tmp_path):
        ...
        # Initialize workspace (workspace IS the .xuanwu directory)
        workspace = tmp_path / ".xuanwu"
